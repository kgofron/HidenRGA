...
/* Generated from ../O.Common/HidenRGA.dbd */
...
epicsShareExtern void (*pvar_func_register_func_asubScanMeasInit)(void);
epicsShareExtern void (*pvar_func_register_func_asubScanMeasRawProc)(void);
epicsShareExtern void (*pvar_func_register_func_asubScanMeasWfProc)(void);
epicsShareExtern void (*pvar_func_register_func_asubScanDispInit)(void);
epicsShareExtern void (*pvar_func_register_func_asubScanDispProc)(void);
epicsShareExtern void (*pvar_func_register_func_asubMIDMeasInit)(void);
epicsShareExtern void (*pvar_func_register_func_asubMIDMeasRawProc)(void);
...
epicsShareExtern int *pvar_int_rga_subDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"rga_subDebug", iocshArgInt, (void * const)pvar_int_rga_subDebug},
	{NULL, iocshArgInt, NULL}
};

int HidenRGA_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/iocs/HidenRGA";
    ...
    (*pvar_func_register_func_asubScanMeasInit)();
    (*pvar_func_register_func_asubScanMeasRawProc)();
    (*pvar_func_register_func_asubScanMeasWfProc)();
    (*pvar_func_register_func_asubScanDispInit)();
    (*pvar_func_register_func_asubScanDispProc)();
    (*pvar_func_register_func_asubMIDMeasInit)();
    (*pvar_func_register_func_asubMIDMeasRawProc)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"HidenRGA_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    HidenRGA_registerRecordDeviceDriver(*iocshPpdbbase);
}
